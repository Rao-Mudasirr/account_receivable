...
import {
    Box, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Grid
} from "@mui/material";
...
import { KPItabledata, KPItableheading } from "../key-performance-indicator/KPI-data";
                    ...
                    <Table sx={{ border: "0" }}>
                        ...
                        <TableBody>
                            {filteredData.map((row, index) => (
                                <TableRow key={index}>
                                    <TableCell sx={{ width: '15%' }} onClick={() => handleKPIStatusClick(index)}>
                                    ...
                                    <TableCell className="font-family-exo2 primary-color primary-title" sx={{ fontWeight: 400, width: '25%' }}>
                                        {row.Formula === "" ?
                                            <Box>
                                                Value (
                                                <span style={{ color: '#0084AD' }}>
                                                    Cash Outflow
                                                </span>
                                                ,0)
                                            </Box> : ""
