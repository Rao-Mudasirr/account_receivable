...
const KeyPerformanceIndicator = ({ openAdd = false, handleClosePerformanceModal }) => {
  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        >
          <GlobalButton btnType btnText="Cancel" onClick={handleClosePerformanceModal} />
          <GlobalButton btnText="Save" btnName="accent" onClick={handleClosePerformanceModal} />
        </Box>
      </Box>
    </SimpleDialog>
  );
