...
import { NotificationsDetailsItem } from '../notifications-details-item/notifications-details-item'
export const NotificationsDetailsContainer = ({notification,index}) => {
  return (
    <>
      <Grid container sx={{ pt: '16px', pb: '32px', borderTop: index === 0 ? '1px solid #C4C4CC' : '', borderBottom: '1px solid #C4C4CC' }}>
        <Grid item xs={.5}>
          <Box sx={{ width: '42px', height: '42px', bgcolor: '#F0F0F2' }} className="border-radius-rounded flex align-center justify-center">
            <Badge invisible={notification?.notiNotRead} color="secondary" sx={{ ".MuiBadge-badge": { top: '-10%', right: '-10%', height: '11px', minWidth: '11px', bgcolor: '#898999' } }} overlap="circular" badgeContent="" variant='' >
