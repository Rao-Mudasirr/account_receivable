...
export const DashboardSelect = ({data,setSelectVal,selectVal}) => {
    return (
        <>
            <Select
                className='font-family-Exo tertiary-color secondary-title font-weight-700'
                sx={{'.MuiSelect-select': {py:0,minWidth:'69px'},'.MuiOutlinedInput-notchedOutline':{border:'0px '},'.MuiSelect-icon':{top:'30%'}}}
                value={selectVal}
                IconComponent= {(props) => (<svg {...props} xmlns="http://www.w3.org/2000/svg" width="18" height="9" viewBox="0 0 18 9" fill="none">
