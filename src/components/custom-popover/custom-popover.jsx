...
export const CustomPopover = ({ popoverOpenerTitle, popoverOpenerProps, mainTitle, mainTitleClass, children }) => {
    return (
        <>
            <PopupState variant="popover" popupId="ar-popup-popover">
                {(popupState) => (
                    <div>
                        <Button {...popoverOpenerProps} {...bindTrigger(popupState)}>
                            {popoverOpenerTitle}
                        </Button>
                        <Popover
                            ...
                            <Box sx={{ width: '592px' }}>
                                <Box sx={{ p: '20px' }}>
                                    <div className='flex justify-between margin-bottom-1'>
                                        ...
                                        <Box sx={{ position: 'absolute', right: '8px', top: '10px' }} className="cursor-pointer" onClick={popupState.close}>
