    ...
    >
      ...
      <form className="tm_form" onSubmit={handleSubmit}>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6} className="tm-textfield_bold">
            ...
            <TextField
              ...
              inputProps={{
                className: "font-family-Exo",
                style: { color: fontColorClass },
              }}
              InputProps={{
                startAdornment: (
                  <InputAdornment position="end">
                    <PoundSign fillColor={fontColorClass} />
                  </InputAdornment>
                ),
              }}
            />
          ...
          <Grid
            ...
            xs={12}
            md={6}
            className="tm-textfield_bold"
          >
            <label className="tm-input_label">
              Issue Date
            </label>
            <TextField
              sx={Styles.field_color}
          ...
          >
            ...
            >
              <MenuItem value={1} sx={{color: categoryValue === "Uncategorized" ? "#FFBF00" : ""}}>
                {categoryValue}
              </MenuItem>
              <MenuItem value={2}>
                Client 2
        ...
        <Grid className="tm_btn">
          ...
          <Button variant="contained" type="submit" onClick={handleUpdateOpen}>
            Update
          </Button>
        </Grid>
      </form>
